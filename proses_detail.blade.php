  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <div class="content">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Process Detail Table</h4>
                  <p class="card-category"> <button class="btn btn-primary" onclick="tambah()">Add Proses Detail</button></p>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php
                          foreach ($proses_details as $key => $value) {
                            echo "<tr>
                              <td id='id".$value->id."'>".$value->id."</td>
                              <td id='proses_id".$value->id."'>".$value->status."</td>
                              <td id='deskripsi".$value->id."'>".$value->deskripsi."</td>
                              <td id='anggaran_biaya".$value->id."'>".$value->anggaran_biaya."</td>
                              <td id='alamat_project".$value->id."'>".$value->alamat_project."</td>
                              <td>
                                <button class='btn btn-sm btn-warning' onclick='ubah(".$value->id.")'' >Ubah</button>
                                <a href='".url('/process-detail/delete/'.$value->id)."' class='btn btn-sm btn-danger'>Delete</button>
                              </td>
       ...
       <!-- Modal -->
       <div class="modal fade" id="ubahprosesdetail" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Change Process Detail</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <form action="<?=url('/process-detail/change')?>" method="POST">
              @csrf <!-- {{ csrf_field() }} -->
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Deskripsi" name="deskripsi" id="ubah_deskripsi">
                    </div>

                    <div class="form-group">
                      <label for="exampleInputEmail1">Anggaran Biaya</label>
                      <input type="text" class="form-control" placeholder="Anggaran Biaya" name="anggaran_biaya" id="anggaran_biaya">
                    </div>

                    <div class="form-group">
                      <label for="exampleInputEmail1">Alamat Project</label>
                      <input type="text" class="form-control" placeholder="Alamat Project" name="alamat_project" id="ubah_alamat_project">
                    </div>
      ...
      <!-- Modal -->
      <div class="modal fade" id="tambahprosesdetail" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Add Process Detail</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <form action="<?=url('/process-detail/add')?>" method="POST" enctype="multipart/form-data">
              @csrf <!-- {{ csrf_field() }} -->
                    <div class="form-group">
                      <label for="exampleInputEmail1">Status</label>
                      <select name="proses_id"  id="tambah_proses_id" class="form-control" placeholder="Status" required>
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Descryption</label>
                      <input type="text" class="form-control" placeholder="Deskripsi" name="deskripsi" id="tambah_deskripsi">
                    </div>

                    <div class="form-group">
                      <label for="exampleInputEmail1">Anggaran Biaya</label>
                      <input type="text" class="form-control" placeholder="Anggaran Biaya" name="anggaran_biaya" id="tambah_anggaran_biaya">
                    </div>

                    <div class="form-group">
                      <label for="exampleInputEmail1">Alamat Project</label>
                      <input type="text" class="form-control" placeholder="Alamat Project" name="alamat_project" id="tambah_alamat_project">
                    </div>
      ...
      <script type="text/javascript">
        ...
        function ubah(id){
          $("#ubah_proses_id").val($("#proses_id"+id).html());
          $("#ubah_deskripsi").val($("#deskripsi"+id).html());
          $("#ubah_anggaran_biaya").val($("#anggaran_biaya"+id).html());
          $("#ubah_alamat_project").val($("#alamat_project"+id).html());
          $("#ubah_id").val($("#id"+id).html());

          $('#ubahprosesdetail').modal('show');
        }

        function tambah(){

          $("#tambah_proses_id").val("");
          $("#tambah_deskripsi").val("");
          $("#tambah_anggaran_biaya").val("");
          $("#tambah_alamat_project").val("");

          $('#tambahprosesdetail').modal('show');
        }
      </script>
     <footer class="footer">
        <div class="container-fluid">
