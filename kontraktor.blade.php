  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <div class="content">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Contractor Table</h4>
                  <p class="card-category"> <button class="btn btn-primary" onclick="tambah()">Add Contractor</button></p>
                </div>
                <div class="card-body">
                        ...
                        <?php
                          foreach ($kontraktors as $key => $value) {
                            echo "<tr>
                              ...
                              <td id='nama_kontraktor".$value->id."'>".$value->nama_kontraktor."</td>
                              ...
                              <td>
                                ...
                                <a href='".url('/contractor/delete/'.$value->id)."' class='btn btn-sm btn-danger'>Delete</button>
                              </td>
       ...
       <!-- Modal -->
       <div class="modal fade" id="ubahkontraktor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Change Contractor</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <form action="<?=url('/contractor/change')?>" method="POST">
              @csrf <!-- {{ csrf_field() }} -->
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Nama Kontrator" name="nama_kontraktor" id="ubah_nama_kontraktor">
                    </div>
      ...
      <!-- Modal -->
      <div class="modal fade" id="tambahkontraktor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
              <form action="<?=url('/contractor/add')?>" method="POST">
              @csrf <!-- {{ csrf_field() }} -->
                    <div class="form-group">
                      <label for="exampleInputEmail1">Username</label>
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nama Kontraktor</label>
                      <input type="text" class="form-control" placeholder="Nama Kontraktor" name="nama_kontraktor" id="tambah_nama_kontraktor">
                    </div>
      ...
      <script type="text/javascript">
        function ubah(id){
          ...
          $("#ubah_nama_kontraktor").val($("#nama_kontraktor"+id).html());
