  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <div class="content">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> <button class="btn btn-primary" onclick="tambah()">Add Proses</button></p>
                </div>
                <div class="card-body">
                        ...
                        <?php
                          foreach ($prosess as $key => $value) {
                            echo "<tr>
                              ...
                              <td id='user_id".$value->id."'>".$value->nama_user."</td>
                              ...
                              <td>
                                ...
                                <a href='".url('/process/delete/'.$value->id)."' class='btn btn-sm btn-danger'>Delete</button>
                              </td>
       ...
       <!-- Modal -->
       <div class="modal fade" id="ubahproses" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Change Process</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <form action="<?=url('/process/change')?>" method="POST">
              @csrf <!-- {{ csrf_field() }} -->
                      <div class="form-group">
                    <label for="exampleInputEmail1">Name User</label>
                      <input type="text" class="form-control" placeholder="Nama User" name="user_id" id="ubah_user_id">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Name Contractor</label>
                      <input type="text" class="form-control" placeholder="Nama Kontraktor" name="kontraktor_id" id="ubah_kontraktor_id">
                    </div>

                    <div class="form-group">
                      <label for="exampleInputEmail1">Status</label>
                      <select class="form-control" placeholder="Status" name="status" id="ubah_status">
      ...
      <!-- Modal -->
      <div class="modal fade" id="tambahproses" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
              <form action="<?=url('/process/add')?>" method="POST" enctype="multipart/form-data">
              @csrf <!-- {{ csrf_field() }} -->
                    <div class="form-group">
                      <label for="exampleInputEmail1">Name User</label>
                      <select name="user_id"  id="tambah_user_id" class="form-control" placeholder="User" required>
      ...
      <script type="text/javascript">
        ...
        function ubah(id){
          $("#ubah_user_id").val($("#user_id"+id).html());
          $("#ubah_kontraktor_id").val($("#kontraktor_id"+id).html());
          $("#ubah_status").val($("#status"+id).html());
