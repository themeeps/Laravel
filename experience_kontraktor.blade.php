  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <div class="content">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Experience Contractor Table</h4>
                  <p class="card-category"> <button class="btn btn-primary" onclick="tambah()">Add Experience Contractor</button></p>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php
                          foreach ($experience_kontraktors as $key => $value) {
                            echo "<tr>
                              <td id='id".$value->id."'>".$value->id."</td>
                              <td id='kontraktor_id".$value->id."'>".$value->nama_kontraktor."</td>
                              <td id='experience".$value->id."'><a href='".url('upload/experience/'.$value->experience)."'>".$value->experience."</a></td>
                              <td id='start_date".$value->id."'>".$value->start_date."</td>
                              <td id='finish_date".$value->id."'>".$value->finish_date."</td>
                              <td>
                                <button class='btn btn-sm btn-warning' onclick='ubah(".$value->id.")'' >Ubah</button>
                                <a href='".url('/experience-contractor/delete/'.$value->id)."' class='btn btn-sm btn-danger'>Delete</button>
                              </td>
       ...
       <!-- Modal -->
       <div class="modal fade" id="ubahexperiencekontraktor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Change Experience Contractor</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <form action="<?=url('/experience-contractor/change')?>" method="POST">
              @csrf <!-- {{ csrf_field() }} -->
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Experience" name="experience" id="ubah_experience">
                    </div>

                    <div class="form-group">
                      <label for="exampleInputEmail1">Start Date</label>
                      <input type="date" class="form-control" placeholder="Start Date" name="start_date" id="ubah_start_date">
                    </div>
                    
                    <div class="form-group">
                      <label for="exampleInputEmail1">Finish Date</label>
                      <input type="date" class="form-control" placeholder="Finish Date" name="finish_date" id="ubah_finish_date">
                    </div>
      ...
      <!-- Modal -->
      <div class="modal fade" id="tambahexperiencekontraktor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Add Experience Contractor</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <form action="<?=url('/experience-contractor/add')?>" method="POST" enctype="multipart/form-data">
              @csrf <!-- {{ csrf_field() }} -->
              <div class="form-group">
                      <label for="exampleInputEmail1">Name Contractor</label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" name="experience" id="tambah_experience">
                    </div>

                    <div class="form-group">
                      <label for="exampleInputEmail1">Start Date</label>
                      <input type="date" class="form-control" placeholder="Start Date" name="start_date" id="tambah_start_date">
                    </div>
                    
                    <div class="form-group">
                      <label for="exampleInputEmail1">Finish Date</label>
                      <input type="date" class="form-control" placeholder="Finish Date" name="finish_date" id="tambah_finish_date">
                    </div>
      ...
      function uploadbtn(){
        $("#tambah_experience").click();
      }
        function ubah(id){
          $("#ubah_kontraktor_id").val($("#kontraktor_id"+id).html());
          $("#ubah_experience").val($("#experience"+id).html());
          $("#ubah_start_date").val($("#start_date"+id).html());
          $("#ubah_finish_date").val($("#finish_date"+id).html());
          $("#ubah_id").val($("#id"+id).html());

          $('#ubahexperiencekontraktor').modal('show');
        }

        function tambah(){

          $("#tambah_kontraktor_id").val("");
          $("#tambah_experience").val("");
          $("#tambah_start_date").val("");
          $("#tambah_finish_date").val("");

          $('#tambahexperiencekontraktor').modal('show');
        }
      </script>
      <footer class="footer">
        <div class="container-fluid">
